...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>SUN RISE QUARANTINE CENTRE,</p>
				<p>(+91) 9790758304</p>
			</address>
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						<td><span ><?php echo $meal; ?> Meal </span></td>
						<td><span ><?php echo $days; ?></span></td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@sunrise.com || Web :- www.sunrise.com || Phone :- +91 9790758304 </p>
			</div>
		</aside>
	</body>
</html>
